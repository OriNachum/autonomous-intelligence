...
import re
import requests
from speaker import Speaker  # Import the Speaker class

class ResponseHandler:
    def __init__(self, tts_url="http://kokoroTTS:8000/speak"):
        self.speaker = Speaker(tts_url=tts_url)  # Initialize Speaker
    ...
    def speak(self, text):
        """Use the Speaker class to speak the given text."""
