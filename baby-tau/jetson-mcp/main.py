...
BASE_URL = LLM_URL
API_KEY = os.getenv("EXAMPLE_API_KEY") or "sk-asdasdasdasdasdasdasdasdasdasd"
MODEL_NAME = os.getenv("EXAMPLE_MODEL_NAME") or "mistralai/Mistral-Small-3.1-24B-Instruct-2503"
