#!/usr/bin/env python3
"""
Gateway Audio - Audio processing component for Reachy Gateway

This module handles:
1. Audio capture and buffering
2. Voice Activity Detection (VAD) or DOA speech detection
3. Speech-to-Text (STT) transcription with Whisper
4. Continuous audio recording with pre-roll buffer
5. DOA sampling and head-pointing logic
"""
...
class GatewayAudio:
    """Audio processing component for gateway service"""
    ...
    def __init__(self, reachy_controller, event_callback, language='en'):
        ...
        logger.info("Gateway Audio initialization complete")
    ...
    def request_shutdown(self):
        """Request shutdown of audio processing"""
